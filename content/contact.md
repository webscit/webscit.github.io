...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">You want to hire us? Or to work with us?</p>
      <form name="contact" action="https://formsubmit.co/2a446ddfb02430825ccae8a7cf223e96" method="POST" class="space-y-8">
          <input type="hidden" name="_subject" value="Contact form submission from website">
          <input type="hidden" name="_next" value="https://webscit.github.io/thanks/">
          <div class="my-4">
